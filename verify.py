...
ENC_B  = bytes([0x39,0x05,0x05,0x44,0xfe,0xc6,0xbc,0xf6,0x20,0x5b,0x41,0x0e,0xfa,0x85,0x24,0xeb])
...
FLAG_A = base64.b64decode("AgAAAAEEAAAARib7ubl5N57ewK3eB0ITNw==")
ENC_A  = bytes([0x5d,0xea,0xe0,0x84,0x4b,0x27,0x79,0x1a,0xf7,0x95,0x11,0xb8,0x3c,0x83,0xfe,0x42])

# 从 precompute_a.py 的逻辑重建
BB6_ADR_OFF = 0x277c  # Release build
