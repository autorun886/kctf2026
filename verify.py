...
ENC_B  = bytes([0x24,0x99,0xd4,0x28,0x9d,0x58,0x69,0x48,0xc7,0x56,0xf5,0xa4,0x44,0x10,0x9e,0xd3])
EXPECTED_SOKEY_CHECK = 0x7d62e67e
...
FLAG_A = base64.b64decode("AgAAAAEEAAAA14Q717l5N57ewK3eB0ITNw==")
ENC_A  = bytes([0xed,0x4f,0xfb,0x46,0xe6,0x5b,0x5c,0xcc,0x6c,0x70,0xcc,0x5e,0xeb,0x6e,0x6b,0xca])

# 从 precompute_a.py 的逻辑重建
BB6_ADR_OFF = 0x26dc  # Release build
