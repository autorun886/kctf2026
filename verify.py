...
ENC_B  = bytes([0x3c,0xc5,0xf9,0x9e,0x8c,0x04,0x73,0xf3,0x3f,0x52,0xde,0xe8,0x3e,0x0b,0x64,0x09])
EXPECTED_SOKEY_CHECK = 0x53ae0627
...
FLAG_A = base64.b64decode("AgAAAAEEAAAAemDONrl5N57ewK3eB0ITNw==")
ENC_A  = bytes([0xdd,0x70,0x87,0x14,0x11,0xbc,0xbc,0x7f,0x37,0x4d,0xb7,0xfe,0xa1,0x80,0x97,0x97])

# 从 precompute_a.py 的逻辑重建
BB6_ADR_OFF = 0x26c0  # Release build
