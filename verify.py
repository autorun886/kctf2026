...
ENC_B  = bytes([0xf5,0x41,0x9b,0x0a,0xbf,0xba,0xc8,0x46,0xd6,0x21,0xfb,0x1e,0xad,0x3b,0x37,0x76])
EXPECTED_SOKEY_CHECK = 0xb486524a
...
FLAG_A = base64.b64decode("AQAAAAEEAAAA690LFLl5N57ewK3eB0ITNw==")
ENC_A  = bytes([0x4b,0xd9,0x6f,0xc8,0x1e,0xdb,0x86,0x9f,0x20,0xbd,0x99,0xe4,0xac,0xdd,0x9d,0xfb])

# 从 precompute_a.py 的逻辑重建
BB6_ADR_OFF = 0x48fc  # Release build
