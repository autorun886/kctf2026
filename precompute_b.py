...
round_keys = [
    struct.unpack_from('<I', material, i*4)[0] ^
    struct.unpack_from('<I', material, 112 + ((i & 3) * 4))[0]
    for i in range(16)
]
configs = []
for i in range(16):
...
delta = struct.unpack_from('<I', material, 96)[0] ^ struct.unpack_from('<I', material, 112)[0]
