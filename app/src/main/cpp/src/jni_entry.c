...
static volatile const uint8_t ENC_EXPECTED_STATE[STATE_LEN] = {
    0x24, 0x99, 0xD4, 0x28, 0x9D, 0x58, 0x69, 0x48,
    0xC7, 0x56, 0xF5, 0xA4, 0x44, 0x10, 0x9E, 0xD3
};
...
static volatile const uint8_t ENC_EXPECTED_STATE2[STATE_LEN] = {
    0xF1, 0xC4, 0xBC, 0x42, 0x88, 0x5B, 0x61, 0xA7,
    0x1F, 0x3B, 0x0B, 0xB0, 0x1A, 0xEC, 0x50, 0x3F
};

/* ── 方案 A 目标状态（precompute_a.py，Release build，CRC=2ba68be6）── */
static volatile const uint8_t ENC_EXPECTED_STATE_A[STATE_LEN] = {
    0xED, 0x4F, 0xFB, 0x46, 0xE6, 0x5B, 0x5C, 0xCC,
    0x6C, 0x70, 0xCC, 0x5E, 0xEB, 0x6E, 0x6B, 0xCA
};
