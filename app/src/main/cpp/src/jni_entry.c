...
static volatile const uint8_t ENC_EXPECTED_STATE[STATE_LEN] = {
    0x3C, 0xC5, 0xF9, 0x9E, 0x8C, 0x04, 0x73, 0xF3,
    0x3F, 0x52, 0xDE, 0xE8, 0x3E, 0x0B, 0x64, 0x09
};
...
static volatile const uint8_t ENC_EXPECTED_STATE2[STATE_LEN] = {
    0xF7, 0x18, 0xCB, 0x20, 0xA5, 0xB2, 0xFE, 0xF9,
    0x9B, 0x17, 0x36, 0x89, 0xF4, 0xD9, 0x1D, 0xE8
};

/* ── 方案 A 目标状态（precompute_a.py，Release build，CRC=2ba68be6）── */
static volatile const uint8_t ENC_EXPECTED_STATE_A[STATE_LEN] = {
    0xDD, 0x70, 0x87, 0x14, 0x11, 0xBC, 0xBC, 0x7F,
    0x37, 0x4D, 0xB7, 0xFE, 0xA1, 0x80, 0x97, 0x97
};
