...
static volatile const uint32_t BB0_BRANCH_OFF = 0x21c8u;
static volatile const uint32_t BB1_OFF        = 0x21d0u;
static volatile const uint32_t BB6_ADR_OFF_V  = 0x26c0u;
static volatile const uint32_t BB7_ENTRY_OFF  = 0x26c8u;
